...
//       <h1 className='rm' style={{color:"dARKred",fontSize:"xx-large" , display: cart.length === 0 ? "none" : "block" }}>HERE IS YOUR FAVOURITE MOVIE LIST</h1>
//  <div className="MovBg">
// {console.log(cart)}
//       {
// cart.length === 0 ? (
//   <>
//   <p className='rm' style={{fontSize:"20px",textTransform:"uppercase",color:"green",textAlign:"center",margin:"auto"}}>Your cart is empty</p>
//   </>
// ) :
//        cart && cart.map((movie)=>
//        (
